  ...
  return (
    <div>
        <div className='header'>
                <img className="encabezado" src="public/imagen_encabezado.jpg" alt="Encabezado" />
      ...
      <section className='section2'>
                <div className="image-grid">
                    <Link to = '/category/homedecor' >
                        <div className="featured-item">
                            <img className='hpimg2' src="public/imagen_destacada1.jpg" alt="Destacado 1" />
                            <p className='category-description'>HOME DECOR</p>
                        </div>
                    </Link>
                    <Link to = '/category/plantaccessories' >
                    <div className="featured-item">
                        <img className='hpimg2' src="public/imagen_destacada2.jpg" alt="Destacado 2" />
                        <p>PLANT ACCESORIES</p>
                    </div>
                    </Link>
                    <Link to = '/category/furniture' >
                    <div className="featured-item">
                        <img className='hpimg2' src="public/imagen_destacada3.jpg" alt="Destacado 3" />
                        <p>FURNITURE</p>
                    </div>
                    </Link>
                    <Link to = '/category/lighting' >
                    <div className="featured-item">
                        <img className='hpimg2' src="public/imagen_destacada4.jpg" alt="Destacado 4" />
                        <p>LIGHTNING</p>
                    </div>
                    </Link>
                    <Link to = '/category/mirrors' >
                    <div className="featured-item">
                        <img className='hpimg2' src="public/imagen_destacada5.jpg" alt="Destacado 5" />
                        <p>MIRRORS</p>
                    </div>
                    </Link>
                    <Link to = '/category/kitchenware' >
                    <div className="featured-item">
                        <img className='hpimg2' src="public/imagen_destacada6.jpg" alt="Destacado 6" />
                        <p>KITCHENWARE</p>
                    </div>
                    </Link>
                </div>
            ...
            <section>
                <div className='section3'>
                    ...
                    <div>
                        <img className='hpimg3' src="public/picturehp1.jpg" alt="decor" />
                    </div>
                </div>
            </section>
    </div>
